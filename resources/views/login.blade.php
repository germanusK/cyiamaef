...
<html lang="en">
  <head>
    ...
    <!-- Animate.css -->
    <link href="{{asset('dash')}}/vendors/animate.css/animate.min.css" rel="stylesheet">
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form method="post">
              ...
              <div>
                <button class="btn btn-default rounded" type="submit">Log in</button>
              </div>
              ...
              <div class="separator">
                ...
                <div>
                  <a href="{{route('home')}}"><h1><i class="fa fa-paw"></i> CYIAMAEF</h1></a>
                </div>
              </div>
            </form>
          </section>
