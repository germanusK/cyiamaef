...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-success ftco_navbar bg-success ftco-navbar-success" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset('assets/images/logo.png') }}" alt="" style="height: 2rem; width: auto;"></a>
        ...
        <div class="row mb-5">
          <div class="col-md-4">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>CYIAMAEF is a youth-focused, community-based organisation committed to empowering young Cameroonians in the fields of health and agriculture. Guided by the principles of unity, excellence, innovation, empowerment, and service, CYIAMAEF works to develop medical and agro talent among the youth, provide medical assistance to underserved communities, promote sanitation, and strengthen food security through sustainable agricultural practices</p>
              <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                <li class="ftco-animate"><a href="#"><span class="icon-youtube"></span></a></li>
                <li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
                <li class="ftco-animate"><a href="#"><span class="icon-tiktok fa fa-tiktok"></span></a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-3">
